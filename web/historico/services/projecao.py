...
def gerar_historico_execucao(chamado: Chamado, finalizado_por=None) -> HistoricoExecucao:
    ...
    historico, _ = HistoricoExecucao.objects.update_or_create(
        ...
        defaults={
            ...
            "projeto_codigo": chamado.projeto.codigo if chamado.projeto else "",
            "projeto_nome": chamado.projeto.nome if chamado.projeto else "",
            "subprojeto_codigo": chamado.subprojeto.codigo if chamado.subprojeto else "",
            "subprojeto_nome": chamado.subprojeto.nome if chamado.subprojeto else "",
            "kit_nome": chamado.kit.nome if chamado.kit else "",
