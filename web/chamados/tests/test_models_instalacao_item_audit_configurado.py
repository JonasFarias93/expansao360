...
class TestInstalacaoItemAuditConfigurado(ChamadoBaseTestCase):
    def test_quando_configura_item_entao_persiste_configurado_em_e_configurado_por_e_flag_configurado(
        self,
    ) -> None:
        User = get_user_model()
